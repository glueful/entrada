...
namespace Glueful\Extensions\Entrada\Tests\Integration\Schema;
...
final class SchemaVerifierBehaviorTest extends TestCase
{
    ...
    private EntradaSchemaVerifier $verifier;
    private string $dbPath;

    protected function setUp(): void
    {
        $this->dbPath = sys_get_temp_dir() . '/entrada-verify-' . uniqid('', true) . '.sqlite';
        ...
        $this->verifier = new EntradaSchemaVerifier();
    }
